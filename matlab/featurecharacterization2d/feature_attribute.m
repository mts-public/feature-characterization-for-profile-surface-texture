...
switch i
    ...
    case length(z) - 2
        ...
        dz2(i) = (2*z(end-7) - 12*z(end-6) + 15*z(end-5) + 200*z(end-4) - ...
    ...
    case length(z) - 1
        ...
        dz2(i) = (-13*z(end-7) + 93*z(end-6) - 285*z(end-5) + 470*z(end-4) ...
    ...
    case length(z)
        ...
        dz2(i) = (137*z(end-7) + 93*z(end-6) - 285*z(end-5) + 470*z(end-4) ...
            - 255*z(end-3) - 147*z(end-2) + 137*z(end-1))/(180*(dx)^2);
    otherwise

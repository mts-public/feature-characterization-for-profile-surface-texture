...
switch i
    ...
    case length(z) - 2
        dz1 = (z(end-6) - 8*z(end-5)+30*z(end-4) - 80*z(end-3) + ...
            35*z(end-2) + 24*z(end-1) - 2*z(end))/(60*dx);
        dz2 = (2*z(end-6) - 12*z(end-5) + 15*z(end-4) + 200*z(end-3) - ...
            420*z(end-2) + 228*z(end-1) - 13*z(end))/(180*(dx)^2);
    case length(z) - 1
        dz1 = (-2*z(end-6) + 15*z(end-5) - 50*z(end-4) + 100*z(end-3) - ...
            150*z(end-2) + 77*z(end-1) + 10*z(end))/(60*dx);
        dz2 = (-13*z(end-6) + 93*z(end-5) - 285*z(end-4) + 470*z(end-3) ...
            - 255*z(end-2) - 147*z(end-1) + 137*z(end))/(180*(dx)^2);
    case length(z)
        dz1 = (10*z(end-6) - 72*z(end-5) + 225*z(end-4) - 400*z(end-3) ...
